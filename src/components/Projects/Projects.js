    ...
    <div id="Project" className={project.projectPage} >
        ...
        <div className={project.projectDetails} >
             <div className={project.projects} >
                <div><h1 className={project.projecttext} >Projects</h1></div>
                  ...
                  <div></div>
                       ...
                       <div className={project.stylesdiv} >
                        ...
                        <div className={project.descriptionstyle} >
                          ...
                          <div className={project.viewdiv}>
                             <div onClick={()=>handleviewMouseEnter("invoice")} className={project.invoiceviewdiv}>view</div>
                             </div>
                          </div>
                          <div  onMouseLeave={()=>handleviewMouseLeave("invoice")} style={{display : invoiceview ? 'block' : 'none'}}  className={project.kanbanvideodiv} >
                          <video  className={project.kanbanvideo} controls>
                  ...
                  <div></div>
                      <div className={project.stylesdiv} >
                        ...
                        <div className={project.descriptionstyle} >
                          ...
                          <div className={project.viewdiv}>
                             <div onClick={()=>handleviewMouseEnter("dictionary")} className={project.dictionaryviewdiv}>view</div>
                             </div>
                          </div>
                          <div  onMouseLeave={()=>handleviewMouseLeave("dictionary")} style={{display : dictionaryview ? 'block' : 'none'}}  className={project.kanbanvideodiv} >
                          <video  className={project.kanbanvideo} controls>
