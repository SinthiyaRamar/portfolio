      ...
      <div className={assign.assignmentdiv}>
        ...
        <div className={assign.projectlistdiv}>
          <div className={assign.projectlistitemdiv}>
            <div
              onClick={() => handleOnclick("js")}
              style={{
                background: js ? "#1e3c81" : "rgb(200 200 200)",
                color: js ? "white" : "black",
              }}
              className={assign.jsdiv}
            >
              VANILLA JS
            </div>
            <div
              ...
              style={{
                background: html ? "#1e3c81" : "rgb(200 200 200)",
                color: html ? "white" : "black",
              }}
              className={assign.htmldiv}
            >
              HTML/CSS
            </div>
            <div
              ...
              style={{
                background: node ? "#1e3c81" : "rgb(200 200 200)",
                color: node ? "white" : "black",
              }}
              className={assign.nodediv}
            >
              NODE JS
            </div>
            <div
              ...
              style={{
                background: react ? "#1e3c81" : "rgb(200 200 200)",
                color: react ? "white" : "black",
              }}
              className={assign.reactdiv}
            >
              REACT
            </div>
            <div
              ...
              style={{
                background: api ? "#1e3c81" : "rgb(200 200 200)",
                color: api ? "white" : "black",
              }}
        ...
        <div className={assign.projectsdiv}>
          ...
          <div
            ...
            className={assign.projectsjsdiv}
          >
              ...
              <div className={assign.firsthalf}>
                ...
                <div className={assign.projectwholediv}>
                  <a
                    className={assign.projectdiv}
                    rel="noreferrer"
                    href="https://stirring-otter-97758d.netlify.app/"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
                ...
                <div className={assign.projectwholediv}>
                  <a
                    rel="noreferrer"
                    className={assign.projectdiv}
                    href="https://tictactoe.sinthiya28.repl.co/"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
              ...
              <div className={assign.secondhalf}>
                ...
                <div className={assign.projectwholediv}>
                  <a
                    rel="noreferrer"
                    className={assign.projectdiv}
                    href="https://music-player-assign8.sinthiya28.repl.co/"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
                ...
                <div className={assign.projectwholediv}>
                  <a
                    rel="noreferrer"
                    className={assign.projectdiv}
                    href="https://js-assignment-5.sinthiya28.repl.co/"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
              ...
              <div className={assign.firsthalf}>
                ...
                <div className={assign.projectwholediv}>
                  <a
                    rel="noreferrer"
                    className={assign.projectdiv}
                    href="https://space.sinthiya28.repl.co/destination.html"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
                ...
                <div className={assign.projectwholediv}>
                  <a
                    rel="noreferrer"
                    className={assign.projectdiv}
                    href="https://assignment11-skilled.sinthiya28.repl.co/"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
                        <h2>Skilled Landing Page</h2>
                      </div>
                      <img
                        className={assign.projectimg}
                ...
                <div className={assign.projectwholediv}>
                  <a
                    rel="noreferrer"
                    className={assign.projectdiv}
                    href="https://suite-landing-page.sinthiya28.repl.co/"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
              ...
              <div className={assign.secondhalf}>
                ...
                <div className={assign.projectwholediv}>
                  <a
                    rel="noreferrer"
                    className={assign.projectdiv}
                    href="https://card-component-assignment6.sinthiya28.repl.co/"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
                ...
                <div className={assign.projectwholediv}>
                  <a
                    className={assign.projectdiv}
                    rel="noreferrer"
                    href="https://3column-card-component-7.sinthiya28.repl.co/"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
                        <h2>3 Column Card Component</h2>
                      </div>
                      <img
                        className={assign.projectimg}
                        src="./images/2cardcomponent.png"
                        alt="projecthtml"
                      />
                    </div>
                  </a>
                ...
                <div className={assign.projectwholediv}>
                  <a
                    rel="noreferrer"
                    className={assign.projectdiv}
                    href="https://connect.zoho.com/portal/zohoschools-2024/tags/html"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
                        <h2>Formula-Fixelarity</h2>
                      </div>
                      <img
                        className={assign.projectimg}
              ...
              <div className={assign.firsthalf}>
                ...
                <div className={assign.projectwholediv}>
                  <a
                    rel="noreferrer"
                    className={assign.projectdiv}
                    href="https://github.com/SinthiyaRamar/kanban-App"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
                ...
                <div className={assign.projectwholediv}>
                  <a
                    rel="noreferrer"
                    className={assign.projectdiv}
                    href="https://github.com/SinthiyaRamar/Invoice"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
                ...
                <div className={assign.projectwholediv}>
                  <a
                    rel="noreferrer"
                    className={assign.projectdiv}
                    href="https://github.com/SinthiyaRamar/Dictionary"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
                      ...
                      <img
                        className={assign.projectimg}
                        src="./images/dictionaryimage.png"
                        alt="projectnode"
                      />
                    </div>
                  </a>
              ...
              <div className={assign.secondhalf}>
                ...
                <div className={assign.projectwholediv}>
                  <a
                    rel="noreferrer"
                    className={assign.projectdiv}
                    href="https://github.com/SinthiyaRamar/IP_Address_Tracker"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
          ...
          {/* react */}
          <div
            style={{ display: react ? "block" : "none" }}
            className={assign.projectshtmldiv}
          >
            <div className={assign.jswholedivs}>
              <div className={assign.firsthalf}>
                ...
                <div className={assign.projectwholediv}>
                  <a
                    rel="noreferrer"
                    className={assign.projectdiv}
                    href="https://apicountry.netlify.app/"
                    target="_blank"
                  >
                    <div className={assign.projectcontent}>
                      <div className={assign.projecttitle}>
