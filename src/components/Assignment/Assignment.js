...
<div className={assign.assignmentpage} >
    <div className={assign.assignmentdiv} >
          ...
          <div className={assign.projectlistitemdiv} >
            ...
            <div onClick={()=>handleOnclick("api")} style={{background : api ? 'green' : 'rgb(109 106 106)'}} className={assign.apidiv} >API</div>
            {/* <div></div> */}
           </div>
          </div>
          <div  className={assign.projectsdiv}  >
            ...
            <div className={assign.projectwholediv} >
               <a className={assign.projectdiv} href="https://final-project.sinthiya28.repl.co/" target="_blank" >
              <div className={assign.projectcontent} >
                 <div className={assign.projecttitle} ><h2>Quiz Game</h2></div>
                <img className={assign.projectimg} src='./images/quiz.png' art="projectjs"/>
              </div>
              </a>
              </div>
          {/* Password Generator */}
             <div className={assign.projectwholediv} >
               <a className={assign.projectdiv} href="https://stirring-otter-97758d.netlify.app/" target="_blank" >
              <div className={assign.projectcontent} >
                 <div className={assign.projecttitle} ><h2>Password Generator</h2></div>
                <img className={assign.projectimg} src='./images/password.png' art="projectjs"/>
              </div>
              </a>
              </div>
            ...
            {/* Tic Tac Toe */}
            <div className={assign.projectwholediv} >
               <a className={assign.projectdiv} href="https://tictactoe.sinthiya28.repl.co/" target="_blank" >
              <div className={assign.projectcontent} >
                 <div className={assign.projecttitle} ><h2>Tic Tac Toe</h2></div>
                <img className={assign.projectimg} src='./images/tictactoe.png' art="projectjs"/>
              </div>
              </a>
              </div>
              </div>
              ...
              {/* Music player */}
              <div className={assign.projectwholediv} >
               <a className={assign.projectdiv} href="https://music-player-assign8.sinthiya28.repl.co/" target="_blank" >
              <div className={assign.projectcontent} >
                 <div className={assign.projecttitle} ><h2>Music Player</h2></div>
                <img className={assign.projectimg} src='./images/musicplayer.png' art="projectjs"/>
              </div>
              </a>
              </div>
              {/* calculator */}
              <div className={assign.projectwholediv} >
               <a className={assign.projectdiv} href="https://js-assignment-5.sinthiya28.repl.co/" target="_blank" >
              <div className={assign.projectcontent} >
                 <div className={assign.projecttitle} ><h2>calculator</h2></div>
                <img className={assign.projectimg} src='./images/calculator.png' art="projectjs"/>
              </div>
              </a>
              </div>
              <div></div>
            ...
            {/* Space Tourism */}
            <div className={assign.projectwholediv} >
               <a className={assign.projectdiv} href="https://space.sinthiya28.repl.co/destination.html" target="_blank" >
              <div className={assign.projectcontent} >
                 <div className={assign.projecttitle} ><h2>Space Tourism</h2></div>
                <img className={assign.projectimg} src='./images/spacetourism.png' art="projecthtml"/>
              </div>
              </a>
              </div>
          {/* Skilled Landing Page */}
             <div className={assign.projectwholediv} >
               <a className={assign.projectdiv} href="https://assignment11-skilled.sinthiya28.repl.co/" target="_blank" >
              <div className={assign.projectcontent} >
                 <div className={assign.projecttitle} ><h2>Skilled Landing Page</h2></div>
                <img className={assign.projectimg} src='./images/skill.png' art="projecthtml"/>
              </div>
              </a>
              </div>
            ...
            {/* Suite Landing Page */}
            <div className={assign.projectwholediv} >
               <a className={assign.projectdiv} href="https://suite-landing-page.sinthiya28.repl.co/" target="_blank" >
              <div className={assign.projectcontent} >
                 <div className={assign.projecttitle} ><h2>Suite Landing Page</h2></div>
                <img className={assign.projectimg} src='./images/suite.png' art="projecthtml"/>
              </div>
              </a>
              </div>
              </div>
              ...
              {/* Card Component */}
              <div className={assign.projectwholediv} >
               <a className={assign.projectdiv} href="https://card-component-assignment6.sinthiya28.repl.co/" target="_blank" >
              <div className={assign.projectcontent} >
                 <div className={assign.projecttitle} ><h2>Card Component</h2></div>
                <img className={assign.projectimg} src='./images/cardcomponent.png' art="projecthtml"/>
              </div>
              </a>
              </div>
              {/* 3 Column Card Component */}
              <div className={assign.projectwholediv} >
               <a className={assign.projectdiv} href="https://3column-card-component-7.sinthiya28.repl.co/" target="_blank" >
              <div className={assign.projectcontent} >
                 <div className={assign.projecttitle} ><h2>3 Column Card Component</h2></div>
                <img className={assign.projectimg} src='./images/2cardcomponent.png' art="projecthtml"/>
              </div>
              </a>
              </div>
              {/*Formula-Fixelarity  */}
           ...
           {/* Node js */}
            ...
            {/* Kanban */}
            <div className={assign.projectwholediv} >
               <a className={assign.projectdiv} href="https://github.com/SinthiyaRamar/kanban-App" target="_blank" >
              <div className={assign.projectcontent} >
                 <div className={assign.projecttitle} ><h2>Kanban</h2></div>
                <img className={assign.projectimg} src='./images/kanban.png' art="projectnode"/>
              </div>
              </a>
              </div>
          {/* Invoice */}
             <div className={assign.projectwholediv} >
               <a className={assign.projectdiv} href="https://github.com/SinthiyaRamar/Invoice" target="_blank" >
              <div className={assign.projectcontent} >
                 <div className={assign.projecttitle} ><h2>Invoice</h2></div>
                <img className={assign.projectimg} src='./images/invoice logo.jpg' art="projectnode"/>
              </div>
              </a>
              </div>
            ...
            {/* rest countries */}
            <div className={assign.projectwholediv} >
               <a className={assign.projectdiv} href="https://apicountry.netlify.app/" target="_blank" >
              <div className={assign.projectcontent} >
                 <div className={assign.projecttitle} ><h2>Rest Countries</h2></div>
                <img className={assign.projectimg} src='./images/restcountries.png' art="projectreact"/>
              </div>
              </a>
              </div>
          {/* Invoice */}
